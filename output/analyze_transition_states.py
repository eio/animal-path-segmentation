...
def collect_transition_states(filepath, status_column):
    ...
    for _, group in grouped_df:
        ...
        # OProcess if there are at least 2 transition indices
    ...
    print("{} total transitions found.\n".format(len(transition_windows)))
...
if __name__ == "__main__":
    ...
    collect_transition_states(args.filepath, PREDICTED)
